...
### to customise html reports summary
def pytest_html_results_summary(prefix,summary,postfix):
    prefix.extend([
        "project: Credence Automation Testing",
        "Environment: QA server",
        "Tester:Sonali Jadhav",
        "Browser:Chrome 130"
    ])
    summary.extend([
        "Test Execution was Sucsessfull and stable"
    ])
    postfix.extend([
        "Report generated by pytest html"
        "note:check screenshot for failed test cases",
        "Project Status: UAT state"
    ])
...
# @pytest.fixture(params=[
#
#     ("Mrunmai","mrunmai101@credence.in", "Test123", "Test123","Pass"),
#     ("Mrunmai","mrunmai101@credence.in", "Test123", "Test1234","Fail")
#
# ])
# def getDataForRegisteration(request):
#     return request.param